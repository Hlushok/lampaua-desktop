...
- синхронізація таймкодів із VLC, KMPlayer, MPC-HC/BE і MPC-QT;
- динамічне завантаження Lampa з адреси за замовчуванням або власного URL;
- експорт та імпорт конфігурації між пристроями;
- збереження позиції, розміру вікна і монітора;
- вбудована підтримка TorrServer;
- автооновлення через релізи LampaUa.
...
Докладна інструкція з першого запуску, плеєрів, TorrServer і типових проблем: [docs/quick-start.md](docs/quick-start.md).
